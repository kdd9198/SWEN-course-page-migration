...
- * 2
  ...
  * * [Domain analysis - individual](/topics/domain-analysis#exercises)
    ...
    * **DB 1**
      * [Chat](/docs/project/db-project/chat-system#db1-initial-schema-test-data-set)
      * [Rideshare](/docs/project/db-project/rideshare#db1-initial-schema-test-data-set)
      * [Library](/docs/project/db-project/library#db1-initial-schema-test-data-set)
...
- * 3
  ...
  * * [Trello Team Initiation](/assignments/trello-initiation)
    ...
    * **DB 2**
      * [Chat](/docs/project/db-project/chat-system#db2-crud--design-iteration)
      * [Rideshare](/docs/project/db-project/rideshare#db2-crud--design-iteration)
      * [Library](/docs/project/db-project/library#db2-crud--design-iteration)
